= Google Docs
This is really just a sketch of a library at the moment, but it will let you do some basic things with the GoogleDocs API.  I've built this with the idea of using it in a Rails project because that's what I'm using it for, but it doesn't have to be so...  
...
* Make a file: config/google_docs.yml with settings for your environments,
